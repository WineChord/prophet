...
renders the curve in the status bar, overlays the latest price at the center on
hover without changing its menu-bar width, and keeps the native hover tooltip as
a secondary detail view.
